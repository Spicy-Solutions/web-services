...
public partial class SweetManagerContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ContractOwner>(entity =>
        {
            ...
            entity.HasIndex(e => e.OwnerId, "owner_id1");
        ...
        modelBuilder.Entity<Hotel>(entity =>
        {
            ...
            entity.HasIndex(e => e.OwnerId, "owner_id2");
        ...
        modelBuilder.Entity<Multimedia>(entity =>
        {
            ...
            entity.HasIndex(e => e.HotelId, "IX_multimedias_hotelId");
        ...
        modelBuilder.Entity<Notification>(entity =>
        {
            ...
            entity.HasIndex(e => e.HotelId, "IX_notifications_hotel_id");
        ...
        modelBuilder.Entity<Provider>(entity =>
        {
            ...
            entity.HasIndex(e => e.HotelId, "hotel_id2");
            ...
            entity.HasOne(d => d.Hotel).WithMany(p => p.Providers)
                .HasForeignKey(d => d.HotelId)
        ...
        modelBuilder.Entity<Room>(entity =>
        {
            ...
            entity.HasIndex(e => e.HotelId, "hotel_id3");
        ...
        modelBuilder.Entity<SmokeSensor>(entity =>
        {
            ...
            entity.HasIndex(e => e.RoomId, "room_id1");
            ...
            entity.Property(e => e.LastAnalogicValue).HasColumnName("last_analogic_value");
        ...
        modelBuilder.Entity<Supply>(entity =>
        {
            ...
            entity.HasIndex(e => e.HotelId, "hotel_id1");
        ...
        modelBuilder.Entity<Thermostat>(entity =>
        {
            ...
            entity.HasIndex(e => e.RoomId, "room_id2");
